...
本lab实现的mmap仅能够实现将文件映射到内存，而正常mmap还应该包括设备的映射（如设备的内存，寄存器等）,但在linux中设备也属于文件，所以没有什么本质区别。
此外还有几种特殊用法：
- 匿名映射，灵活内存管理，类似malloc的作用
- 共享内存，用于进程间通信
- 提供缓存优化
- 修改页面保护

可以参考下这个博客：https://luyoung0001.github.io/2024/06/12/mmap()%20%E7%9A%84%E5%87%A0%E7%A7%8D%E7%94%A8%E6%B3%95/
